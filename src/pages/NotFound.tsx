...
export const NotFound: React.FC = () => {
  ...
  return (
    <PageContainer>
      <section className="min-h-[70vh] flex items-center justify-center bg-[#F8FAFC] py-20">
        <div className="nox-container text-center max-w-xl">
          <div className="w-16 h-16 rounded-2xl border border-[#BBD3F2] bg-[#EFF6FF] flex items-center justify-center text-[#1E3A8A] mx-auto mb-6 shadow-sm">
